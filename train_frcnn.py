...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default="/home/yangdoudou/fasterrcnn")
...
for epoch_num in range(num_epochs):
	...
	while True:
		try:
			...
			print('train_frcnn :: Exception: {}'.format(e))
			#print(e.__traceback__.tb_frame.f_globals["__file__"])   # 发生异常所
